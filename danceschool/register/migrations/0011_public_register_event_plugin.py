# Generated by Django 5.2.3 on 2026-03-16 15:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autoCheckIn', models.CharField(choices=[('0', 'No automatic check-in'), ('E', 'Current event occurrence (next ending time)'), ('S', 'Current event occurrence (next starting time)'), ('F', 'Entire event')], default='E', max_length=1, verbose_name='Automatic event/occurrence check-in when registration is complete')),
                ('title', models.CharField(blank=True, default='Upcoming Events', max_length=250, verbose_name='Section title')),
                ('cssClasses', models.CharField(blank=True, help_text='Classes are applied to the surrounding &lt;div&gt;', max_length=250, null=True, verbose_name='Custom CSS classes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('optionLabel', models.CharField(blank=True, default='', help_text='Optional prefix shown before the role name, e.g. "Sign up as". Leave blank to show only the role name.', max_length=100, verbose_name='Label prefix')),
                ('soldOutRule', models.CharField(choices=[('D', 'Display with sold-out label'), ('H', 'Hide sold-out choices')], default='D', max_length=1, verbose_name='Rule for sold-out choices')),
                ('data', models.JSONField(blank=True, default=dict, help_text='Custom JSON stored with each registration produced by this choice. This value is kept server-side and is never transmitted through the browser, so it cannot be modified by users.', verbose_name='Additional data attached to registrations')),
                ('order', models.PositiveSmallIntegerField(default=0)),
                ('eventPlugin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='register.publicregistereventpluginmodel', verbose_name='Plugin')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='%(app_label)s_%(class)s', serialize=False, to='cms.cmsplugin')),
                ('title', models.CharField(blank=True, default='', help_text='Optional text displayed at the left edge of the navbar. Leave blank to show navigation links only.', max_length=200, verbose_name='Navbar brand text')),
            ],
            options={
