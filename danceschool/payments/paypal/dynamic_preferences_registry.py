...
class FixedTransactionFee(FloatPreference):
    ...
    help_text = _(
        'Paypal fees consist of a fixed fee plus a percentage of the total ' +
        'price.  When a refund is made, the  the U.S., the variable ' +
        'percentage is refunded, but the fixed fee is not.  In the U.S., ' +
        'this fixed fee is $0.30.  Entering your country\'s fee here ensures ' +
        'that your accounting will remain accurate when you refund students.'
    )
    default = 0.30
