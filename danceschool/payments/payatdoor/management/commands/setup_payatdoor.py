...
-----------------------------------------
        ...
        if add_payatdoor:
            ...
            if alias_content.placeholder.get_plugins().filter(plugin_type='PayAtDoorFormPlugin').exists():
            ...
            if add_willpayatdoor:
                ...
                if not home_page:
                    ...
                    if alias_content.placeholder.get_plugins().filter(plugin_type='WillPayAtDoorFormPlugin').exists():
