# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-08-11 17:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rentalRate', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Expense Rate')),
                ...
                ('advanceDays', models.PositiveSmallIntegerField(default=30, help_text='By default, expense items are generated from rules up to 30 days in advance.  To generate expense items further (or less far) in advance, enter the number of days here.', verbose_name='Generate expenses up to __ days in advance')),
                ('priorDays', models.PositiveSmallIntegerField(blank=True, default=180, help_text='By default, expense items are generated from rules up to 180 days in the past.  To generate expense items further (or less far) in the past, enter the number of days here.  Leave blank for no limit.', null=True, verbose_name='Generate expenses up to __ days in the past')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='expenseitem',
            name='expenseRule',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='financial.RepeatedExpenseRule', verbose_name='Expense generation rule'),
        ),
